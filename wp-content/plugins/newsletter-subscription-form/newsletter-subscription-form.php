...
define( 'NLS_VERSION', '1.1.12'); // Plugin Version Number
...
function nls_settings_link($links) {
	...
	$nls_pro_link = '<a href="https://weblizar.com/plugins/newsletter-subscription-form-pro/" target="_blank">Get Pro</a>';
    array_unshift($links, $nls_settings_link, $nls_pro_link);
    return $links;
}
