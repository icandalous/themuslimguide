			...
			<div class="tab-content">
				<div id="weblizar-template" class="tab-pane fade in active"><!-- plugin template free theme layout selection setting -->		
					<form method="post" id="weblizar_nls_template_option">
						...
						<?php for($i=1; $i<=2; $i++){ ?>
						<div class="col-md-6 col-sm-6 op_tem site_template <?php if($wl_nls_options['select_template']=='select_template'.$i) echo 'active'; ?>" id="select_template<?php echo $i?>" onclick="pretheme()">	
						...
						<?php for($i=3; $i<=6; $i++){ ?>
						<div class="col-md-6 col-sm-6 op_tem site_template" id="select_template<?php echo $i?>" onclick="protheme()">	
							<div class="selected_template">	
								...
								<h4 class="op_name"><?php _e('Theme '.$i,NLS_TEXT_DOMAIN);?></h4>
